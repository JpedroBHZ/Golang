...
func main() {
	...
	//Estruturas de repetições criam ciclos que se repetem até um condição ser atendida
	//A estrutura for, usa uma variavel de controle e para quando ela chega no valor delimitado
	for i := 0; i < 2; i++ {
